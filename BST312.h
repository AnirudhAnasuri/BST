...
{
    //YOUR CODE GOES HERE
    // everything can be done in the helper function, so this just calls the helper
...
vector<ItemType> BST_312 <ItemType>::preOrderTraversal()
{
    ...
    preOrderTraversal(root, preOrderTraverse);
...
vector<ItemType> BST_312 <ItemType>::inOrderTraversal()
{
    ...
    inOrderTraversal(root, inOrderTraverse);
...
vector<ItemType> BST_312 <ItemType>::postOrderTraversal()
{
    ...
    postOrderTraversal(root, postOrderTraverse);
...
{
    //YOUR CODE GOES HERE
    // function already present to traverse the array. Any of the three traversals work
    bool found = false;
    vector<ItemType> values = preOrderTraversal();
